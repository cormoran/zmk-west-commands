/*
 * Simulated BLE host ("central") that exercises the ZMK Studio RPC service
 * over BLE, for BabbleSim BLE tests driven by `west zmk-ble-test`.
 *
 * This is the copyable *skeleton*: it is module-agnostic. The request
 * payloads it writes come from a generated `requests.inc` (produced by the
 * companion `generate_requests.py`), never hand-encoded here. Copy this
 * whole directory into your module as `tests/ble/<name>_central/`, edit and
 * run `generate_requests.py` to describe your request sequence, and the
 * runner will discover, build and stage it automatically. See README.md.
 *
 ...
 * hexdump every de-framed response payload.
 *
...
LOG_MODULE_REGISTER(studio_ble_central, 4);
 ...
 * GENERATED by generate_requests.py -- edit the Python, not this include.
 * Defines:
